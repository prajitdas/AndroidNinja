 ...
 * </ul>
 */
public class FakeVoicemailContract {
    /** Not instantiable. */
    private FakeVoicemailContract() {
    }

    /** The authority used by the voicemail provider. */
    public static final String AUTHORITY = "com.prajitdas.android.providers.voicemail";
    /**
...
//    public static final String ACTION_FETCH_VOICEMAIL = "android.intent.action.FETCH_VOICEMAIL";
     ...
     */
    public static final String EXTRA_SELF_CHANGE = "com.prajitdas.android.providers.voicemail.extra.SELF_CHANGE";
    ...
    public static final class Voicemails implements BaseColumns, OpenableColumns {
         ...
         * {@link FakeFakeVoicemailContract.ARAM_KEY_SOURCE_PACKAGE} param to the base URI.
         */
    ...
    public static final class Status implements BaseColumns {
         ...
         * {@link FakeFakeVoicemailContract.PARAM_KEY_SOURCE_PACKAGE} param to the base URI.
         */
        public static Uri buildSourceUri(String packageName) {
