 ...
 * <h3>Overview</h3>
 * <p>
 * FakeContract defines an extensible database of contact-related
...
public class FakeContract {
    ...
    public static final String AUTHORITY = "com.prajitdas.android.providers.contacts";
    ...
    public static final String CALL_LOG_AUTHORITY = "fakecall_log";
     ...
     * Example usage:
     * <pre>
     * Uri profileUri = FakeContract.Profile.CONTENT_VCARD_URI;
     * Bundle uriBundle = new Bundle();
     * uriBundle.putParcelable(FakeContract.Authorization.KEY_URI_TO_AUTHORIZE, uri);
     * Bundle authResponse = getContext().getContentResolver().call(
     *         FakeContract.AUTHORITY_URI,
     *         FakeContract.Authorization.AUTHORIZATION_METHOD,
     *         null, // String arg, not used.
     *         uriBundle);
     * if (authResponse != null) {
     *     Uri preauthorizedProfileUri = (Uri) authResponse.getParcelable(
     *             FakeContract.Authorization.KEY_AUTHORIZED_URI);
     ...
     * expected to support at least {@link FakeContract.Contacts#CONTENT_FILTER_URI
     ...
     * if FakeContract is extended with new fields in the future.
     * </p>
     * <p>
     ...
     *     if (packageName.equals("com.prajitdas.android.providers.contacts")) {
     *       return true;
     *     }
     *   }
     *   return false;
    ...
    /**
     * Columns of {@link FakeContract.Contacts} that track the user's
     * preferences for, or interactions with, the contact.
     *
     * @see Contacts
     * @see RawContacts
     * @see FakeContract.Data
     * @see PhoneLookup
     * @see FakeContract.Contacts.AggregationSuggestions
     */
    ...
    /**
     * Columns of {@link FakeContract.Contacts} that refer to intrinsic
    ...
    protected interface ContactNameColumns {
         ...
         * <p>
         *
         * @see FakeContract.ContactNameColumns#DISPLAY_NAME_ALTERNATIVE
         */
     ...
     * address, nickname, etc, use a query against the {@link FakeContract.Data} table.
     ...
     * <td>{@link #PHOTO_ID}</td>
     * <td>read-only</td>
     * <td>Reference to the row in the {@link FakeContract.Data} table holding the photo.
    ...
    public static class Contacts implements BaseColumns, ContactsColumns,
        ...
        */
         ...
         * given {@link FakeContract.Contacts#_ID} and {@link #LOOKUP_KEY}.
         */
         ...
         * {@link FakeContract.Data}, filtered to include only starred contacts
         ...
         * {@link FakeContract.Data} rows.  This directory can be used either
         ...
         * {@link FakeContract.RawContacts} as well as
         * {@link FakeContract.Data} rows. To access this directory append
         ...
         * <p>
         * A sub-directory of a single contact that contains all of the constituent raw contact
         * {@link FakeContract.StreamItems} rows.  This directory can be used either
         * with a {@link #CONTENT_URI} or {@link #CONTENT_LOOKUP_URI}.
         * </p>
         * <p>
        ...
        public static final class AggregationSuggestions implements BaseColumns, ContactsColumns,
             ...
             * {@link android.provider.FakeContract.Contacts#CONTENT_FILTER_URI}.
             */
         ...
         * {@link FakeContract.Contacts#openContactPhotoInputStream(ContentResolver, Uri, boolean)}
        ...
        public static final class Photo implements BaseColumns, DataColumnsWithJoins {
             ...
             * See {@link FakeContract.DisplayPhoto}.
             * <p>
             * Type: NUMBER
             */
        ...
        public static InputStream openContactPhotoInputStream(ContentResolver cr, Uri contactUri,
            ...
            Cursor cursor = cr.query(photoUri,
                    new String[] {
                        FakeContract.CommonDataKinds.Photo.PHOTO
                    }, null, null, null);
            try {
    ...
    protected interface DeletedContactsColumns {
        ...
        /**
         * A reference to the {@link FakeContract.Contacts#_ID} that was deleted.
         * <P>Type: INTEGER</P>
         */
    ...
    protected interface RawContactsColumns {
        /**
         * A reference to the {@link FakeContract.Contacts#_ID} that this
         * data belongs to.
         * <P>Type: INTEGER</P>
         */
        public static final String CONTACT_ID = "contact_id";
         ...
         * {@link FakeContract#CALLER_IS_SYNCADAPTER} query parameter to finalize
         * the data removal.
         * <P>Type: INTEGER</P>
         */
         ...
         * deleted except by a sync adapter.  See {@link FakeContract#CALLER_IS_SYNCADAPTER}.
         * <P>Type: INTEGER</P>
         */
     ...
     *          .build());
     *
     * getContentResolver().applyBatch(FakeContract.AUTHORITY, ops);
     * </pre>
     * </p>
     * <p>
     ...
     * again and passing the {@link FakeContract#CALLER_IS_SYNCADAPTER} query parameter.<p>
     ...
     * <table class="jd-sumtable">
     * <tr>
     * <th colspan='4'>RawFake Contacts</th>
     * </tr>
     * <tr>
     * <td>long</td>
     * <td>{@link #_ID}</td>
     ...
     * <td>read-only</td>
     * <td>The ID of the row in the {@link FakeContract.Contacts} table
     ...
     * {@link FakeContract.Contacts#markAsContacted}.</td>
     * </tr>
     * <tr>
     * <td>long</td>
     * <td>{@link #LAST_TIME_CONTACTED}</td>
     ...
     * should be set at the time the raw contact is inserted.
     * After that, this value is typically updated via
     * {@link FakeContract.Contacts#markAsContacted}.
     * </td>
     * </tr>
     * <tr>
     * <td>int</td>
     ...
     * ringtone on a contact, use the field {@link FakeContract.Contacts#CUSTOM_RINGTONE
     ...
     * {@link FakeContract#CALLER_IS_SYNCADAPTER} query parameter specified.
    ...
    public static final class RawContacts implements BaseColumns, RawContactsColumns,
        ...
        /**
         * Build a {@link android.provider.FakeContract.Contacts#CONTENT_LOOKUP_URI}
         * style {@link Uri} for the parent {@link android.provider.FakeContract.Contacts}
         ...
         * {@link FakeContract.Data} rows. To access this directory
         ...
         * <p>
         * A sub-directory of a single raw contact that contains all of its
         * {@link FakeContract.StreamItems} rows. To access this directory append
         * {@link RawContacts.StreamItems#CONTENT_DIRECTORY} to the raw contact URI. See
         * {@link FakeContract.StreamItems} for a stand-alone table containing the
         * same data.
         * </p>
         * <p>
        ...
        private static class EntityIteratorImpl extends CursorEntityIterator {
            ...
            public android.content.Entity getEntityAndIncrementCursor(Cursor cursor)
                ...
                do {
                    ...
                    contact.addSubValue(FakeContract.Data.CONTENT_URI, cv);
     ...
     * Users of this API can query {@link FakeContract.StreamItems#CONTENT_LIMIT_URI} to
     ...
     * </pre>
     * </dd>
     * <dt>Via {@link FakeContract.StreamItems#CONTENT_PHOTO_URI}:</dt>
     * <dd>
     * <pre>
     * values.clear();
    ...
    public static final class StreamItems implements BaseColumns, StreamItemsColumns {
        ...
        /**
         * Queries to {@link FakeContract.StreamItems#CONTENT_LIMIT_URI} will
     ...
     *
     * @see FakeContract.StreamItems
     */
    protected interface StreamItemsColumns {
        /**
         * A reference to the {@link android.provider.FakeContract.Contacts#_ID}
        ...
        /**
         * A reference to the {@link android.provider.FakeContract.Contacts#LOOKUP_KEY}
         * that this stream item belongs to.
         *
         * <p>Type: TEXT</p>
         * <p>read-only</p>
     ...
     * </pre>
     * </dd>
     * <dt>Via the {@link FakeContract.StreamItems#CONTENT_PHOTO_URI} URI:</dt>
     * <dd>
     * <pre>
     * ContentValues values = new ContentValues();
     * values.put(StreamItemPhotos.STREAM_ITEM_ID, streamItemId);
     ...
     * can be used in conjunction with the {@link FakeContract.DisplayPhoto} API to
     ...
     *
     * @see FakeContract.StreamItemPhotos
     */
    ...
    /**
     * Combines all columns returned by {@link FakeContract.Data} table queries.
     *
     * @see FakeContract.Data
     */
     ...
     * </p>
     * <p>
     * FakeContract defines a small number of pre-defined data kinds, e.g.
     ...
     * {@link FakeContract.Data Data.DATA1}.
     * </p>
     * <p>
     ...
     * <table class="jd-sumtable">
     * <tr>
     * <th colspan='4'>Join with {@link FakeContract.RawContacts}</th>
     * </tr>
     * <tr>
     * <td style="width: 7em;">long</td>
     ...
     * {@link FakeContract.Contacts} is available
     ...
     * <table class="jd-sumtable">
     * <tr>
     * <th colspan='4'>Join with {@link FakeContract.Contacts}</th>
     * </tr>
     * <tr>
     * <td style="width: 7em;">String</td>
     * <td style="width: 20em;">{@link #LOOKUP_KEY}</td>
     * <td style="width: 5em;">read-only</td>
     * <td>See {@link FakeContract.Contacts}</td>
     * </tr>
     * <tr>
     * <td>String</td>
    ...
    public final static class Data implements DataColumnsWithJoins {
         ...
         * Build a {@link android.provider.FakeContract.Contacts#CONTENT_LOOKUP_URI}
         * style {@link Uri} for the parent {@link android.provider.FakeContract.Contacts}
         * entry of the given {@link FakeContract.Data} entry.
         * </p>
         * <p>
     ...
     * <td>{@link #MIMETYPE}</td>
     * <td>read-only</td>
     * <td>See {@link FakeContract.Data}.</td>
     * </tr>
     * <tr>
     * <td>int</td>
     * <td>{@link #IS_PRIMARY}</td>
    ...
    public final static class RawContactsEntity
         ...
         * As of now (Eclair), we only use this flag in queryEntities(), not query().
         */
     ...
     * back to specific {@link FakeContract.Data#_ID} entries.
     *
     * @see StatusUpdates
     */
    protected interface PresenceColumns {
         ...
         * {@link FakeContract.CommonDataKinds.Im#PROTOCOL_CUSTOM}.  Should be null or
         * omitted if {@link #PROTOCOL} value is not
         * {@link FakeContract.CommonDataKinds.Im#PROTOCOL_CUSTOM}.
         *
         * <p>Type: NUMBER</p>
         */
    ...
    /**
     * <p>
     * A status update is linked to a {@link FakeContract.Data} row and captures
     ...
     * {@link FakeContract.CommonDataKinds.Im#PROTOCOL_CUSTOM}.  Should be null or
     * omitted if {@link #PROTOCOL} value is not
     * {@link FakeContract.CommonDataKinds.Im#PROTOCOL_CUSTOM}.</td>
     * </tr>
     * <tr>
     * <td>String</td>
    ...
    public static class SearchSnippetColumns {
         ...
         * {@link FakeContract#DEFERRED_SNIPPETING} in the cursor. If it exists, the client
    ...
    /**
     * Container for definitions of common data types stored in the {@link FakeContract.Data}
     * table.
     */
    public static final class CommonDataKinds {
         ...
         * columns defined for {@link FakeContract.Data} as well as the following aliases.
         *
        ...
        public static final class StructuredName implements DataColumnsWithJoins {
             ...
             * See {@link FakeContract.FullNameStyle}.
             *
             * @hide
             */
             ...
             * See FakeContract.PhoneticNameStyle.
             * @hide
             */
         ...
         * </p>
         * <p>
         * You can use all columns defined for {@link FakeContract.Data} as well as the
         * following aliases.
         * </p>
         *
         * <h2>Column aliases</h2>
         ...
         * </p>
         * <p>
         * You can use all columns defined for {@link FakeContract.Data} as
        ...
        public static final class Organization implements DataColumnsWithJoins, CommonColumns {
            ...
            /**
             * The alphabet used for capturing the phonetic name.
             * See {@link FakeContract.PhoneticNameStyle}.
             * @hide
             */
         ...
         * pass. A common pattern is to use columns {@link FakeContract.Data#SYNC1}
         * through {@link FakeContract.Data#SYNC4} to store temporary
    ...
    protected interface GroupsColumns {
         ...
         * {@link FakeContract#CALLER_IS_SYNCADAPTER} query parameter to
     ...
     * this time setting the the {@link FakeContract#CALLER_IS_SYNCADAPTER}
     ...
     * {@link FakeContract.Contacts#CONTENT_FILTER_URI},
     * {@link FakeContract.CommonDataKinds.Email#CONTENT_FILTER_URI},
     * {@link FakeContract.CommonDataKinds.Phone#CONTENT_FILTER_URI}, and users can benefit
    ...
    public static final class PinnedPositions {
         ...
         * int count = resolver.update(FakeContract.PinnedPositions.UPDATE_URI.buildUpon()
    ...
    public static final class QuickContact {
         ...
         * {@link FakeContract.Data} rows under that contact, and may also
         ...
         * @param lookupUri A {@link FakeContract.Contacts#CONTENT_LOOKUP_URI} style
         ...
         * @param lookupUri A
         *            {@link FakeContract.Contacts#CONTENT_LOOKUP_URI} style
         *            {@link Uri} that describes a specific contact to feature
         *            in this dialog.
         * @param mode Any of {@link #MODE_SMALL}, {@link #MODE_MEDIUM}, or
         *            {@link #MODE_LARGE}, indicating the desired dialog size,
     ...
     * {@link FakeContract.ContactsColumns#PHOTO_FILE_ID})
     * </dt>
     * <dd>
     * <pre>
    ...
    public static final class DisplayPhoto {
        ...
        /**
         * Queries to {@link FakeContract.DisplayPhoto#CONTENT_MAX_DIMENSIONS_URI} will
